...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    {
        public SharedGameObject origine;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (origine != null && origine.Value)
            {
                transform = origine.Value.transform;
            }
        ...
        public override void OnDrawGizmos()
        {
            ...
            MovementUtility.DrawLineOfSight(transform, offset.Value, fieldOfViewAngle.Value, angleOffset2D.Value, viewDistance.Value, usePhysics2D);
        }
